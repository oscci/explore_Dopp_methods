...
Have appended factor scores and plots to A2_5_SEM.R

Shows good reliability for first factor (around .85), less so for 2nd factor.
Also factors are positively correlated.
